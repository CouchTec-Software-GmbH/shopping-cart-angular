  ...
  template: `
    ...
    >
      ...
      <div class="mb-4">
        ...
        />
        <a
          class="text-xs text-blue-600 hover:text-blue-700 hover:cursor-pointer"
          (click)="onResetPassword()"
        >
          Ich habe mein Password vergessen.</a
        >
      </div>
      <div class="mb-6">
        <input
      ...
      <div>
        <button
          class="w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg text-white"
        >
          Anmelden
        </button>
      </div>
      ...
      <div
        role="alert"
        class="rounded border-s-4 border-yellow-500 bg-yellow-50 p-4 my-5"
        *ngIf="submitted && status !== 200"
      >
