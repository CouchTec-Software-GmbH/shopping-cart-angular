...
<path d="M21 7h-4V3h-2v4h-4v2h4v4h2V9h4"/>
     ...
     <button
          ...
          class="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
          role="menuitem"
        >
<svg width="20px" height="20px" fill="currentColor" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
